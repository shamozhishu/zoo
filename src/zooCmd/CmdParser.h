...
public:
    ...
    void setAppUsage(AppUsage* usage) { _usage = usage; }
    AppUsage* getAppUsage() { return _usage; }
    const AppUsage* getAppUsage() const { return _usage; }
    ...
    /** This convenience method handles help requests on the command line.
        ...
        * function is suitable for passing into getAppUsage()->write().
        * If AppUsage::NO_HELP is returned then no help commandline option
        * was found on the command line. */
    AppUsage::Type readHelpType();
